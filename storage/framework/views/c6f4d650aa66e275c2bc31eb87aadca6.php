    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('ctf-events')); ?>" class="flex items-center gap-3">
            ...
            <div class="hidden md:flex items-center gap-6">
                <a href="<?php echo e(route('ctf-events')); ?>" class="text-gray-400 hover:text-[#00ff41] font-mono text-sm transition-colors">
                    EVENTS
                </a>
...
</nav><?php /**PATH D:\security-monetize-challenge\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>