        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gradient-to-br from-[#1a0b2e] to-[#0d0015] border border-[#00ff41]/20 rounded-lg p-6 hover:border-[#00ff41]/50 transition-all group">
                    ...
                    <h3 class="text-lg font-mono font-bold text-white mb-2"><?php echo e($feature['title']); ?></h3>
                    <p class="text-gray-400 text-sm"><?php echo e($feature['description']); ?></p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div>
                    ...
                    <?php else: ?>
                        <div class="bg-[#0d0015] border border-[#00ff41]/20 rounded-lg overflow-hidden">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center p-4 border-b border-[#00ff41]/10 last:border-0 hover:bg-[#00ff41]/5 transition-colors">
                                    <div class="w-12 h-12 flex items-center justify-center font-mono font-bold text-xl <?php echo e($index < 3 ? 'text-[#00ff41]' : 'text-gray-500'); ?>">
                                        #<?php echo e($index + 1); ?>

                                    </div>
                                    <div class="flex-1 px-4">
                                        <div class="flex items-center gap-2">
                                            <h4 class="font-mono font-bold text-white"><?php echo e($user->name); ?></h4>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($index === 0): ?> <span class="text-yellow-400 text-xs">👑</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <p class="text-xs text-gray-500 font-mono"><?php echo e($user->total_solves); ?> solves</p>
                                    </div>
                                    <div class="font-mono font-bold text-[#00ff41] text-lg">
                                        <?php echo e($user->total_points); ?> pts
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                ...
                <div class="bg-gradient-to-br from-[#1a0b2e] to-[#0d0015] border border-[#00ff41]/20 rounded-lg p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex gap-4">
                            ...
                            <div>
                                <h4 class="font-mono font-bold text-white"><?php echo e($item['title']); ?></h4>
...
<?php /**PATH D:\security-monetize-challenge\resources\views/livewire/ctf-events.blade.php ENDPATH**/ ?>