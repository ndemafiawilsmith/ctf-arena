    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('ctf-events') }}#events" class="text-gray-400 hover:text-[#00ff41]">Events</a></li>
                    <li><a href="{{ route('ctf-events') }}#leaderboard" class="text-gray-400 hover:text-[#00ff41]">Leaderboard</a></li>
                    <li><a href="{{ route('ctf-events') }}#events" class="text-gray-400 hover:text-[#00ff41]">Challenges</a></li>
        ...
        <div class="border-t border-[#00ff41]/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-gray-500 font-mono text-sm">
                © {{ date('Y') }} CTF_ARENA. All rights reserved.
            </p>
            <p class="text-gray-500 font-mono text-sm">
