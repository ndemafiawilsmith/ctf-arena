  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "CTF Arena",
      "url": "https://ctf.cyberwilsmith.com.ng",
      "logo": "https://ctf.cyberwilsmith.com.ng/images/logo.png",
      "description": "Africa's premier Capture The Flag (CTF) cybersecurity competition platform",
      "foundingDate": "2025",
      "areaServed": ["Nigeria", "Africa", "Ghana", "Kenya", "South Africa", "Egypt"],
      "sameAs": [
        "https://twitter.com/ctfarena",
        "https://linkedin.com/company/ctfarena",
        "https://github.com/ctfarena"
      ],
      "contactPoint": {
        "@type": "ContactPoint",
        "email": "ctf@cyberwilsmith.com.ng",
  ...
  <script type="application/ld+json">
    {
      ...
      "name": "CTF Arena",
      "url": "https://ctf.cyberwilsmith.com.ng",
      "description": "Nigeria's Premier Capture The Flag Cybersecurity Platform",
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://ctf.cyberwilsmith.com.ng/search?q={search_term_string}",
        "query-input": "required name=search_term_string"
      }
    }
  </script>

  {{-- Structured Data - Event (for CTF competitions) --}}
  <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Event",
      "name": "CTF Arena Cybersecurity Competition",
      "description": "Join live Capture The Flag cybersecurity competitions with real challenges and cash prizes",
      "url": "https://ctf.cyberwilsmith.com.ng",
      ...
      "offers": {
        ...
        "url": "https://ctf.cyberwilsmith.com.ng/register"
      }
    }
  </script>
  ...
  <script type="application/ld+json">
    {
      ...
      "mainEntity": [{
          "@type": "Question",
          "name": "What is CTF Arena?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "CTF Arena is Nigeria and Africa's premier Capture The Flag (CTF) cybersecurity competition platform where hackers compete in real challenges, win cash prizes, and improve their security skills."
          }
        },
        {
          "@type": "Question",
          "name": "How do I participate in CTF competitions in Nigeria?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Simply register for a free account on CTF Arena, browse available events, and join challenges. Our platform offers both free practice events and paid competitions with cash prizes."
          }
        },
        {
          "@type": "Question",
          "name": "Is CTF Arena free to use?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! CTF Arena offers free registration and many free challenges. We also host premium paid events with cash prizes for competitive hackers."
          }
        },
        {
          "@type": "Question",
          "name": "What types of CTF challenges are available?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "CTF Arena offers challenges in web exploitation, cryptography, reverse engineering, forensics, OSINT, binary exploitation, and more. All powered by real TryHackMe labs."
          }
        }
      ]
    }
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center gap-3">
            <svg class="text-[#00ff41]" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="bg-gradient-to-br from-[#1a0b2e] to-[#0d0015] border border-[#00ff41]/20 rounded-lg p-6 hover:border-[#00ff41]/50 transition-all group">
            <div class="w-14 h-14 rounded-lg bg-black/50 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-[#00ff41]">
          ...
          <div class="bg-gradient-to-br from-[#1a0b2e] to-[#0d0015] border border-[#00ff41]/20 rounded-lg p-6 hover:border-[#00ff41]/50 transition-all group">
            <div class="w-14 h-14 rounded-lg bg-black/50 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-purple-400">
